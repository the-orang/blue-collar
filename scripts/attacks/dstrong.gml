...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_absa_whip_charge"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("shovel_swing"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 154);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITPAUSE_SCALING, 1.25);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, 198);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, asset_get("sfx_may_whip2"));
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("dorito"));
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_HSPEED, 4);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_VSPEED, -10);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_GRAVITY, 0.4);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_GROUND_FRICTION, .01);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_AIR_FRICTION, .02);
...
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_DESTROY_EFFECT, 304);
