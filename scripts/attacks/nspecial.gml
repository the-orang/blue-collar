...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("fox_grab"));

set_window_value(AT_NSPECIAL, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_LENGTH, 16);
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_ANIM_FRAMES, 1);set_window_value(AT_NSPECIAL, 2, AG_WINDOW_ANIM_FRAME_START, 1);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.45);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("fox_throw"));
