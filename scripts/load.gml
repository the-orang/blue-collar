...
sprite_change_offset("dattack", 78, 94)
sprite_change_offset("ftilt", 130, 158)
...
sprite_change_offset("bair", 89, 132)
sprite_change_offset("uair", 73, 96)
sprite_change_offset("dair", 79, 84)
sprite_change_offset("fstrong", 83, 94)
sprite_change_offset("ustrong", 82, 146)
sprite_change_offset("dstrong", 80, 126)
sprite_change_offset("nspecial", 78, 98)
sprite_change_offset("fspecial", 79, 94)
sprite_change_offset("uspecial", 76, 98)
sprite_change_offset("dspecial", 72, 98)
sprite_change_offset("taunt", 80, 126)
