...
initial_dash_time = 11 // 8 – 16. The number of frames in your initial dash
initial_dash_speed = 8 // 4 – 11. The speed of your initial dash in pixels per frame
dash_speed = 7.5 // 4.75 – 9. The speed of your run in pixels per frame
dash_turn_time = 8 // 8 – 20. The number of frames it takes to turn while running
...
roll_forward_max = 10 // 9 – 11. The speed of your forward roll
roll_backward_max = 10 // 9 – 11. The speed of your backward roll
...
air_friction = .04 // .02 – .07. Natural deceleration applied while in the air. Also applies while in hitstun, increasing survivability

max_fall = 11 // 8 – 11. The maximum vsp you can accelerate to while falling normally
fast_fall = 15 // 11 – 16. The vsp applied when fastfalling
gravity_speed = .55 // .3 – .6. The gravitational acceleration applied in non-hitstun aerial states
...
short_hop_speed = 7 // 4 – 7.4	The vsp applied when shorthopping
jump_speed = 11 // 7.6 – 12. The vsp applied when fullhopping
...
walk_anim_speed = .25 //The speed of your walk animation in anim frames per gameplay frame
dash_anim_speed = .4 //The speed of your dash animation in anim frames per gameplay frame
...
crouch_startup_frames = 2 // The number of animation frames during crouch’s startup
...
dodge_active_frames = 3 //	Number of animation frames during parry’s active frames
dodge_recovery_frames = 2 // Number of animation frames during parry’s recovery frames
